...
<h4>서영석</h4>저는 이번 레크레이션 강사를 위한 게임 웹서비스를 프로젝트에서는 기간 안에서 코드를 직접 작성하기에는 불가능 하게 판단되어 다른 소스를 모방하여 만든 점이 아쉬웠으며, 엔티티 연관 관계 중요성과 더욱 자세하고 구체적으로  요구사항을 생각하게 되었고,  제가 더욱 열심히 해야 겠다는 다짐과 결심이 되는 계기가 되었습니다.
